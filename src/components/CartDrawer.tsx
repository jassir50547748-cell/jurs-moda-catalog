                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-0.5">
                      {item.color && (
                        <span className="text-[10px] bg-accent/10 text-accent px-1.5 py-0.5 rounded-full">{item.color}</span>
                      )}
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <div className="flex items-center gap-0">
                        <button
                          ...
                          className="w-8 h-8 rounded-l-lg bg-secondary border border-border flex items-center justify-center hover:bg-muted transition-colors"
                        >
                          <Minus className="h-3.5 w-3.5 text-foreground" />
                        </button>
                        <div className="w-10 h-8 border-y border-border flex items-center justify-center bg-card">
                          <span className="text-sm font-bold text-foreground">{item.quantity}</span>
                        </div>
                        <button
                          onClick={() => updateQuantity(item.productId, item.quantity + 1, item.color)}
                          className="w-8 h-8 rounded-r-lg bg-secondary border border-border flex items-center justify-center hover:bg-muted transition-colors"
                        >
